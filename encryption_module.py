...
class SubstitutionCipher(Cipher):
    ...
    def encrypt(self, text):
        ...
        for char in text:
            if char.isalpha():
                if char.islower():
                    encrypted_text += self.key[self.alphabet.index(char)]
                else:
                    encrypted_text += self.key[self.alphabet.index(char.lower())].upper()
            else:
                encrypted_text += char
        return encrypted_text
    ...
    def decrypt(self, text):
        ...
        for char in text:
            if char.isalpha():
                if char.islower():
                    decrypted_text += self.alphabet[self.key.index(char)]
                else:
                    decrypted_text += self.alphabet[self.key.index(char.lower())].upper()
            else:
                decrypted_text += char
        return decrypted_text
